...
namespace main_savitch_4
{
    ...
    public:
        ...
        value_type current( ) const;
    private:
        value_type *data; // a pointer to a dynamic array
        size_type used; // size_type variable keeps track of current length sequence
        size_type current_index; //an index to the current item
        size_type capacity; // size_type variable keeps track of complete capacity of dynamic array
    };
}
